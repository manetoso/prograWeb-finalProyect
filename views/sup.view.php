        ...
        <div class="row d-flex justify-content-center mt-5 mb-5">
            <div class="card col-md-8">
                <article class="card-body">
                    <h1 class="card-title mb-1 mt-1 text-center">Aréa del Supervisor</h1>
                    <form method="POST" action="procesoLogin.php">
                        <div class="form-group">
                            ...
                            <div class="row justify-content-md-center mt-3">
                                ...
                                <a href="../procesos/procesoUsr.php" class="btn btn-success">Ver usuarios</a>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Estás dentro del menú de acciones del Supervisor.</p>
